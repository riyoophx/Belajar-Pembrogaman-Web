<html>
    ...
    <body>
        ...
        */
        ...
        $menit2 = 34;
        $detik2 = 45;
        $totalDetik1 = $jam1 * 3600 + $menit1 * 60 + $detik1; // total detik waktu pertama
        $totalDetik2 = $jam2 * 3600 + $menit2 * 60 + $detik2; // total detik waktu kedua
        $selisih = $totalDetik1 - $totalDetik2; // selisih dalam detik
