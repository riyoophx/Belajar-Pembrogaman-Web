<html>
    ...
    <body>
        ...
        <?php
        /*
        Script ini akan menghitung gaju bersih yang dirumuskan dengan
        Gaji Bersih = Gaji + tunjangan - pajak;
        Misalkan gaji pokok Rp. 1.000.000, tunjangan Rp. 500.000 dan
